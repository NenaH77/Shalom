    ...
    if(Token::check(Input::get('token'))) {
        ...
        if ($validate->passed()) {
            ...
            try {
                ...
                Session::flash('home', 'Welcome ' . Input::get('username') . '! Your account has been registered. You may now log in.  <a href="login.php">Login</a>');
...
<form class="form-signin action="" method="post">
    ...
    <input class="btn btn-lg btn-danger btn-block" type="button" name="cancel" value="Cancel" onclick="location.href='login.php'" />
</form>
